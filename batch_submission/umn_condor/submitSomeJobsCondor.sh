...
./condorPhotoNSuperSim -n 140 -src ybe -set 6 -ngen 1000000 -prim -otype root -merge -template soudan_photon_neutron_bridgeshiftUpdate.mac.template -exe

#use this for sbbe 0x0006 photoneutron jobs
#./condorPhotoNSuperSim -n 140 -src sbbe -set 6 -ngen 1000000 -prim -otype root -merge -template soudan_photon_neutron_bridgeshiftUpdate.mac.template -exe
